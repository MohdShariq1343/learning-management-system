        ...
        <div className='card-img-top'>
          {
            ...
            <img src={enrollment.course.course_small_image} alt="" className='img-fluid' />
          }
          {
            enrollment.course.course_small_image == '' &&
           <img src={`https://placehold.co/600x350?text=${enrollment.course.title}`} alt="" className='img-fluid' />
             }
            </div>
